/*
*   basado en: https://stackoverflow.com/questions/4965335/how-to-print-binary-tree-diagram-in-java#8948691
*
*/
    ...
    private static <T extends Comparable<? super T>> void printNodeInternal(List<Node<T>> nodes, int level, int maxLevel) {
        ...
        for (Node<T> node : nodes) {
            if (node != null && node.getData() != null) {
                if(node.color == 1) {
                    System.out.print("\033[1;31m" + node.getData() + "\033[0;37m");
                    
                } else {
                    System.out.print("\033[1;30m" + node.getData() + "\033[0;37m");
                }
        ...
        for (int i = 1; i <= endgeLines; i++) {
            for (int j = 0; j < nodes.size(); j++) {
                ...
                if (nodes.get(j).getLeft() != null && nodes.get(j).getLeft().getData() != null)
                    System.out.print("/");
                else
                ...
                if (nodes.get(j).getRight() != null && nodes.get(j).getRight().getData() != null)
                    System.out.print("\\");
                else
                    BTreePrinter.printWhitespaces(1);
